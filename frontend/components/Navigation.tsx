...
export default function Navigation() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/5 bg-background-subtle/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-3 py-2 md:px-6 md:py-4">
        <div className="flex items-center gap-2 md:gap-6 flex-1 min-w-0">
          ...
          {/* Navegação desktop - esconder no mobile */}
        ...
        <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 md:gap-2 rounded-full bg-brand-primary/80 px-3 py-1.5 md:px-5 md:py-2 text-xs md:text-sm font-semibold text-white transition hover:bg-brand-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-secondary/70"
            title="Sair"
          >
